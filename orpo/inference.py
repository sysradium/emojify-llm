...
peft_model = PeftModel.from_pretrained(base_model, "Qwen2-0.5B-PEFT-ORPO/checkpoint-375")
...
text_generator = pipeline("text-generation", model=peft_model, tokenizer=tokenizer, device=device)
